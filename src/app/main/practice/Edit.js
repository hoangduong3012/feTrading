...
import { updatePracticeDetail } from './store/practiceSlice';
...
export default function Edit(props) {
  ...
  const { control, handleSubmit, setValue } = useForm({
    mode: 'onChange',
    defaultValues: props.practice.attributes,
    resolver: yupResolver(schema),
  });
  const dispatch = useDispatch();
  const loadingUpdate = useSelector(({ practice }) => practice.loadingUpdate);
  function onSubmit(value) {
    dispatch(updatePracticeDetail({...value , id:  props.practice.id}));
  }
